...
private:
	...
	// The main render target when BackbufferSettings::PRESENTATION_HEADLESS is
	// selected. It replaces the drawable supplied by CAMetalLayer and is not a
	// Lua-visible Texture.
	id<MTLTexture> virtualBackbuffer;
