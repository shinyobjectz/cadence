...
--   luajit model/lua/props.lua <root> <comp.lua> <t1> [t2 ...]
-- Output: { "fps":30, "duration":..., "nodes":[{id,kind}], "at":{"1.0":{"text1":{"x":..,"opacity":..}}} }
...
local out = { fps = comp.fps or 30, duration = comp.duration, nodes = {}, at = setmetatable({}, { __jsontype = "object" }) }
for _, n in ipairs(comp.nodes) do
  out.nodes[#out.nodes + 1] = { id = n.id, kind = n.kind }
end
for i = 3, #arg do
